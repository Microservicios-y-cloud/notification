...
public class EmailService {
    ...
    public void sentPaymentFailEmail(
    String destinationEmail,
    String customerName,
    BigDecimal amount,
    String orderId) throws MessagingException {
        ...
        final String templateName = EmailTemplates.PAYMENT_REJECTED.getTemplate();
        ...
        Context context = new Context();
        context.setVariables(variables);
        messageHelper.setSubject(EmailTemplates.PAYMENT_REJECTED.getSubject());
